...
const QUIZ_BANK: Record<string, Record<number, BankQuestion[]>> = {
    genesis: {
        ...
        2: [
            { question: "Como se chamava o jardim onde Deus colocou o homem?", answer: "Éden", distractors: ["Canaã", "Gosém"], reference: "Gênesis 2:8" },
            { question: "De onde Deus formou o homem?", answer: "Do pó da terra", distractors: ["Da água", "De uma costela"], reference: "Gênesis 2:7" },
            { question: "De onde Deus formou a mulher?", answer: "De uma costela de Adão", distractors: ["Do pó da terra", "Da água do rio"], reference: "Gênesis 2:21-22" },
            { question: "Qual árvore Deus proibiu o homem de comer?", answer: "A árvore do conhecimento do bem e do mal", distractors: ["A árvore da vida", "A árvore do jardim"], reference: "Gênesis 2:16-17" },
            { question: "O que Deus disse que não era bom?", answer: "O homem estar só", distractors: ["A criação dos animais", "O jardim do Éden"], reference: "Gênesis 2:18" },
            { question: "O que Adão fez com todos os animais que Deus trouxe a ele?", answer: "Deu nomes a eles", distractors: ["Sacrificou alguns a Deus", "Ordenou que partissem"], reference: "Gênesis 2:19-20" },
            { question: "Qual era o nome do rio que regava o jardim do Éden e se dividia em quatro?", answer: "Um rio saía do Éden e se dividia em quatro braços", distractors: ["O Eufrates era o único rio", "Havia dois rios no Éden"], reference: "Gênesis 2:10-14" },
            { question: "Por que Adão chamou a mulher de 'mulher'?", answer: "Porque foi tirada do homem", distractors: ["Porque Deus assim a nomeou", "Porque era mais forte que ele"], reference: "Gênesis 2:23" },
        ],
        3: [
            { question: "Que animal enganou Eva?", answer: "A serpente", distractors: ["O leão", "O corvo"], reference: "Gênesis 3:1-6" },
            { question: "O que a serpente disse que aconteceria se comessem o fruto proibido?", answer: "Que seriam como Deus, conhecendo o bem e o mal", distractors: ["Que viveriam para sempre", "Que ganhariam força"], reference: "Gênesis 3:4-5" },
            { question: "O que Adão e Eva fizeram ao perceber que estavam nus?", answer: "Costuraram folhas de figueira para cobrir-se", distractors: ["Fugiram para o rio", "Pediram perdão a Deus"], reference: "Gênesis 3:7" },
            { question: "Para onde Deus expulsou Adão e Eva?", answer: "Para fora do jardim do Éden", distractors: ["Para o deserto de Zurma", "Para além do rio Eufrates"], reference: "Gênesis 3:23-24" },
            { question: "O que Deus colocou para guardar o jardim após a expulsão?", answer: "Querubins e uma espada flamejante", distractors: ["Anjos sem espada", "Um muro de pedras"], reference: "Gênesis 3:24" },
            { question: "Qual foi a punição dada à serpente?", answer: "Rastejar no pó e haver inimizade com a mulher", distractors: ["Ser transformada em pedra", "Ser exilada para o deserto"], reference: "Gênesis 3:14-15" },
            { question: "Que nome Adão deu à sua mulher após a queda?", answer: "Eva", distractors: ["Sara", "Miriã"], reference: "Gênesis 3:20" },
            { question: "O que Deus fez por Adão e Eva antes de expulsá-los?", answer: "Fez vestes de peles para vesti-los", distractors: ["Deu-lhes frutos para a jornada", "Ensinou-os a plantar"], reference: "Gênesis 3:21" },
        ],
        4: [
            { question: "Como se chamavam os dois primeiros filhos de Adão e Eva?", answer: "Caim e Abel", distractors: ["Sete e Enos", "Noé e Sem"], reference: "Gênesis 4:1-2" },
            { question: "O que Abel ofereceu a Deus?", answer: "Primogênitos do seu rebanho", distractors: ["Frutos da terra", "Pão e vinho"], reference: "Gênesis 4:4" },
            { question: "O que Caim fez com Abel?", answer: "Matou-o", distractors: ["Vendeu-o como escravo", "Expulsou-o de suas terras"], reference: "Gênesis 4:8" },
            { question: "Para onde Caim foi após matar Abel?", answer: "Para a terra de Node", distractors: ["Para o Egito", "Para além do rio Jordão"], reference: "Gênesis 4:16" },
            { question: "O que Deus pôs em Caim para que ninguém o matasse?", answer: "Um sinal", distractors: ["Uma marca de fogo", "Uma coroa de espinhos"], reference: "Gênesis 4:15" },
            { question: "Como se chamava o filho de Caim que deu nome a uma cidade?", answer: "Enoque", distractors: ["Sete", "Lameque"], reference: "Gênesis 4:17" },
            { question: "Quem foi Lameque?", answer: "Descendente de Caim que tinha duas esposas", distractors: ["Filho de Abel", "Primeiro filho de Adão e Eva"], reference: "Gênesis 4:19" },
            { question: "Quando se começou a invocar o nome do Senhor?", answer: "Nos dias de Enos, filho de Sete", distractors: ["Nos dias de Abel", "Nos dias de Caim"], reference: "Gênesis 4:26" },
        ],
        5: [
            { question: "Quantos anos viveu Matusalém?", answer: "969 anos", distractors: ["930 anos", "777 anos"], reference: "Gênesis 5:27" },
            { question: "Quem foi levado por Deus sem passar pela morte?", answer: "Enoque", distractors: ["Noé", "Sete"], reference: "Gênesis 5:24" },
            { question: "Quantos anos viveu Adão ao todo?", answer: "930 anos", distractors: ["969 anos", "777 anos"], reference: "Gênesis 5:5" },
            { question: "Quem era o pai de Noé?", answer: "Lameque", distractors: ["Matusalém", "Enoque"], reference: "Gênesis 5:28-29" },
            { question: "Quais eram os três filhos de Noé?", answer: "Sem, Cam e Jafé", distractors: ["Caim, Abel e Sete", "Enos, Cainã e Maalaleel"], reference: "Gênesis 5:32" },
            { question: "Quantos anos viveu Enoque antes de ser tomado por Deus?", answer: "365 anos", distractors: ["969 anos", "500 anos"], reference: "Gênesis 5:23" },
            { question: "Quantos anos viveu Lameque?", answer: "777 anos", distractors: ["930 anos", "365 anos"], reference: "Gênesis 5:31" },
            { question: "Quantos anos tinha Noé quando gerou Sem, Cam e Jafé?", answer: "500 anos", distractors: ["300 anos", "600 anos"], reference: "Gênesis 5:32" },
        ],
        6: [
            { question: "Por que Deus decidiu destruir a humanidade?", answer: "A maldade dos homens era grande na terra", distractors: ["Por causa de uma grande seca", "Porque os homens não trabalhavam"], reference: "Gênesis 6:5-7" },
            { question: "Quem encontrou graça aos olhos do Senhor?", answer: "Noé", distractors: ["Enoque", "Matusalém"], reference: "Gênesis 6:8" },
            { question: "De que material Deus mandou Noé construir a arca?", answer: "Madeira de gofer", distractors: ["Cedro do Líbano", "Madeira de carvalho"], reference: "Gênesis 6:14" },
            { question: "Quantos andares tinha a arca?", answer: "Três andares", distractors: ["Dois andares", "Cinco andares"], reference: "Gênesis 6:16" },
            { question: "Quantos animais de cada espécie Noé devia levar para a arca?", answer: "Dois de cada espécie, macho e fêmea", distractors: ["Sete de cada espécie", "Um de cada espécie"], reference: "Gênesis 6:19" },
            { question: "Como Deus descreveu o coração dos homens antes do dilúvio?", answer: "Toda imaginação era má continuamente", distractors: ["Os homens eram preguiçosos", "Os homens não adoravam a Deus"], reference: "Gênesis 6:5" },
            { question: "Qual era o comprimento da arca?", answer: "Trezentos côvados", distractors: ["Cem côvados", "Quinhentos côvados"], reference: "Gênesis 6:15" },
            { question: "Além dos animais, o que Noé devia levar para a arca?", answer: "Alimento de todo tipo para si e para os animais", distractors: ["Ouro e prata", "Apenas sementes de plantas"], reference: "Gênesis 6:21" },
        ],
        7: [
            { question: "Por quantos dias e noites choveu sobre a terra?", answer: "Quarenta dias e quarenta noites", distractors: ["Sete dias e sete noites", "Cem dias e cem noites"], reference: "Gênesis 7:12" },
            { question: "Quantos anos tinha Noé quando entrou na arca?", answer: "Seiscentos anos", distractors: ["Quinhentos anos", "Setecentos anos"], reference: "Gênesis 7:6" },
            { question: "Dos animais limpos, quantos pares Noé devia levar?", answer: "Sete pares", distractors: ["Um par", "Dois pares"], reference: "Gênesis 7:2" },
            { question: "Quem fechou a porta da arca?", answer: "O próprio Senhor", distractors: ["Noé", "Os filhos de Noé"], reference: "Gênesis 7:16" },
            { question: "Quantos dias as águas prevaleceram sobre a terra?", answer: "Cento e cinquenta dias", distractors: ["Quarenta dias", "Um ano"], reference: "Gênesis 7:24" },
            { question: "O que as águas cobriram completamente?", answer: "Todos os altos montes debaixo do céu", distractors: ["Apenas os vales e planícies", "As cidades dos ímpios"], reference: "Gênesis 7:19" },
            { question: "Quem entrou na arca?", answer: "Noé, sua família e todos os animais conforme Deus ordenou", distractors: ["Apenas Noé e sua esposa", "Noé e todos que quiseram entrar"], reference: "Gênesis 7:7-9" },
            { question: "Quinze côvados acima dos montes subiram as águas. O que isso significa?", answer: "As águas cobriram os montes mais altos em 15 côvados", distractors: ["Os montes cresceram 15 côvados", "A arca flutuou 15 côvados acima"], reference: "Gênesis 7:20" },
        ],
        8: [
            { question: "Que pássaro Noé soltou primeiro da arca?", answer: "Um corvo", distractors: ["Uma pomba", "Uma águia"], reference: "Gênesis 8:7" },
            { question: "Qual pássaro trouxe um ramo de oliveira para Noé?", answer: "A pomba", distractors: ["O corvo", "A andorinha"], reference: "Gênesis 8:11" },
            { question: "Onde a arca parou após o dilúvio?", answer: "Nos montes de Ararate", distractors: ["No monte Sinai", "No monte Carmelo"], reference: "Gênesis 8:4" },
            { question: "O que Noé construiu logo ao sair da arca?", answer: "Um altar ao Senhor", distractors: ["Uma casa para sua família", "Uma cidade"], reference: "Gênesis 8:20" },
            { question: "Quantas vezes Noé soltou a pomba?", answer: "Três vezes", distractors: ["Duas vezes", "Quatro vezes"], reference: "Gênesis 8:8-12" },
            { question: "O que a pomba trouxe na segunda vez que foi soltada?", answer: "Um ramo de oliveira no bico", distractors: ["Nada, voltou vazia", "Uma folha de figueira"], reference: "Gênesis 8:11" },
            { question: "O que Deus prometeu após o sacrifício de Noé?", answer: "Nunca mais amaldiçoar a terra por causa do homem", distractors: ["Dar terras férteis a Noé", "Enviar anjos para guardá-los"], reference: "Gênesis 8:21" },
            { question: "O que aconteceu quando a pomba foi solta pela terceira vez?", answer: "Não voltou mais", distractors: ["Trouxe uma pedra", "Voltou com um peixe"], reference: "Gênesis 8:12" },
        ],
        9: [
            { question: "Qual sinal Deus estabeleceu como sinal da aliança com Noé?", answer: "O arco-íris nas nuvens", distractors: ["A lua cheia", "Uma estrela especial"], reference: "Gênesis 9:12-16" },
            { question: "O que Deus autorizou o homem a comer após o dilúvio?", answer: "Carne dos animais, além das plantas", distractors: ["Apenas plantas e frutos", "Apenas peixes e aves"], reference: "Gênesis 9:3" },
            { question: "O que Noé plantou após o dilúvio?", answer: "Uma vinha", distractors: ["Um campo de trigo", "Um jardim de oliveiras"], reference: "Gênesis 9:20" },
            { question: "O que aconteceu com Noé depois de beber do vinho?", answer: "Embriagou-se e ficou descoberto em sua tenda", distractors: ["Adormeceu no campo", "Dançou diante do altar"], reference: "Gênesis 9:21" },
            { question: "Quem cobriu a nudez de Noé com respeito?", answer: "Sem e Jafé", distractors: ["Cam", "Todos os três filhos"], reference: "Gênesis 9:23" },
            { question: "O que aconteceu com Canaã por causa da atitude de Cam?", answer: "Foi amaldiçoado por Noé", distractors: ["Foi expulso da família", "Ficou doente"], reference: "Gênesis 9:25" },
            { question: "Quantos anos viveu Noé depois do dilúvio?", answer: "Trezentos e cinquenta anos", distractors: ["Duzentos anos", "Quinhentos anos"], reference: "Gênesis 9:28" },
            { question: "Qual era a lei que Deus deu sobre derramar sangue humano?", answer: "Quem derramar sangue humano, pelo homem terá o seu sangue derramado", distractors: ["Seria exilado da terra", "Pagaria com seus bens"], reference: "Gênesis 9:6" },
        ],
        10: [
            { question: "Quem foi descrito como o primeiro homem poderoso na terra?", answer: "Ninrode", distractors: ["Jabal", "Jubal"], reference: "Gênesis 10:8" },
            { question: "De qual filho de Noé descende Ninrode?", answer: "De Cam, pelo filho Cuxe", distractors: ["De Sem", "De Jafé"], reference: "Gênesis 10:6,8" },
            { question: "Qual cidade foi o início do reino de Ninrode?", answer: "Babel", distractors: ["Nínive", "Ur dos Caldeus"], reference: "Gênesis 10:10" },
            { question: "De qual filho de Noé descendem os cananeus?", answer: "De Cam", distractors: ["De Sem", "De Jafé"], reference: "Gênesis 10:15-18" },
            { question: "De qual filho de Noé descende Israel (linha semítica)?", answer: "De Sem", distractors: ["De Cam", "De Jafé"], reference: "Gênesis 10:21-31" },
            { question: "Como é chamada a listagem de Gênesis 10?", answer: "A tabela das nações", distractors: ["O livro das genealogias", "O registro dos reinos"], reference: "Gênesis 10:1-32" },
            { question: "Qual era a profissão conhecida de Ninrode?", answer: "Era caçador poderoso diante do Senhor", distractors: ["Era rei guerreiro", "Era sacerdote e profeta"], reference: "Gênesis 10:9" },
            { question: "Quantos filhos de Noé têm seus descendentes listados em Gênesis 10?", answer: "Três: Sem, Cam e Jafé", distractors: ["Apenas dois: Sem e Cam", "Apenas um: Sem"], reference: "Gênesis 10:1" },
        ],
        11: [
            { question: "Como se chamava o lugar onde os homens decidiram construir a torre?", answer: "Planície de Sinear", distractors: ["Vale do Jordão", "Monte Arará"], reference: "Gênesis 11:1-2" },
            { question: "Por que os homens queriam construir uma torre que chegasse ao céu?", answer: "Para fazer um nome para si e não se dispersarem", distractors: ["Para homenagear a Deus", "Para se proteger de inundações"], reference: "Gênesis 11:4" },
            { question: "O que Deus fez para deter a construção da torre de Babel?", answer: "Confundiu a linguagem deles", distractors: ["Destruiu a torre with fogo", "Enviou um grande vento"], reference: "Gênesis 11:7-9" },
            { question: "O que significa o nome 'Babel'?", answer: "Confusão", distractors: ["Grandeza", "Paz"], reference: "Gênesis 11:9" },
            { question: "Quem era o pai de Abrão?", answer: "Terá", distractors: ["Naor", "Harã"], reference: "Gênesis 11:26" },
            { question: "De onde Terá saiu com sua família?", answer: "De Ur dos Caldeus", distractors: ["De Harã", "De Babel"], reference: "Gênesis 11:31" },
            { question: "Para onde Terá planejava ir, mas parou em Harã?", answer: "Para a terra de Canaã", distractors: ["Para o Egito", "Para a Assíria"], reference: "Gênesis 11:31" },
            { question: "Com quantos anos morreu Terá?", answer: "Com 205 anos", distractors: ["Com 175 anos", "Com 120 anos"], reference: "Gênesis 11:32" },
        ],
        12: [
            { question: "O que Deus prometeu a Abrão ao chamá-lo?", answer: "Fazer dele uma grande nação e abençoá-lo", distractors: ["Dar-lhe longa vida e saúde", "Torná-lo rei de Canaã"], reference: "Gênesis 12:1-3" },
            { question: "Com quantos anos Abrão saiu de Harã?", answer: "Com 75 anos", distractors: ["Com 60 anos", "Com 90 anos"], reference: "Gênesis 12:4" },
            { question: "Quem acompanhou Abrão na saída de Harã?", answer: "Sarai, Ló e toda a casa que tinham adquirido", distractors: ["Apenas Sarai e seus servos", "Naor e seus filhos"], reference: "Gênesis 12:5" },
            { question: "Onde Deus apareceu a Abrão e prometeu dar aquela terra à sua descendência?", answer: "Em Siquém, no carvalho de Moré", distractors: ["Em Belém, no vale do Jordão", "Em Hebrom, junto ao carvalho"], reference: "Gênesis 12:6-7" },
            { question: "Por que Abrão pediu a Sarai que se apresentasse como irmã no Egito?", answer: "Tinha medo de ser morto por causa da beleza dela", distractors: ["Para enganar o faraó e ficar rico", "Porque era costume no Egito"], reference: "Gênesis 12:11-13" },
            { question: "O que o faraó deu a Abrão por causa de Sarai?", answer: "Ovelhas, bois, jumentos, servos e camelos", distractors: ["Ouro e prata", "Terras e palácios"], reference: "Gênesis 12:16" },
            { question: "Como Deus interveio quando Sarai estava no palácio do faraó?", answer: "Feriu o faraó e sua casa com grandes pragas", distractors: ["Enviou um anjo para avisá-la", "Falou em sonho ao faraó"], reference: "Gênesis 12:17" },
            { question: "Após sair do Egito, para onde Abrão foi primeiro?", answer: "Para o Neguebe, depois para Betel", distractors: ["Diretamente para Canaã", "Para Siquém"], reference: "Gênesis 13:1,3" },
        ],
        13: [
            { question: "Por que Abrão e Ló decidiram se separar?", answer: "A terra não comportava os dois — havia contenda entre os pastores", distractors: ["Deus mandou Ló para outra região", "Ló queria se tornar independente"], reference: "Gênesis 13:5-7" },
            { question: "Qual região Ló escolheu para si?", answer: "Toda a campina do Jordão, em direção a Sodoma", distractors: ["A terra de Canaã à direita", "As montanhas do Neguebe"], reference: "Gênesis 13:10-11" },
            { question: "Após a separação de Ló, o que Deus prometeu a Abrão?", answer: "Que toda a terra que ele via seria de sua descendência", distractors: ["Que teria um filho em breve", "Que seus inimigos seriam vencidos"], reference: "Gênesis 13:14-15" },
            { question: "Onde Abrão se estabeleceu após a separação de Ló?", answer: "Em Hebrom, junto ao carvalho de Manre", distractors: ["Em Betel", "Em Siquém"], reference: "Gênesis 13:18" },
            { question: "Como era descrita a campina do Jordão que Ló escolheu?", answer: "Toda regada, como o jardim do Senhor e como o Egito", distractors: ["Árida e pobre em pastos", "Coberta de florestas densas"], reference: "Gênesis 13:10" },
            { question: "Perto de qual cidade Ló armou suas tendas?", answer: "Perto de Sodoma", distractors: ["Perto de Gomorra", "Perto de Zoar"], reference: "Gênesis 13:12" },
            { question: "O que Deus disse sobre a descendência de Abrão em Gênesis 13?", answer: "Que seria como o pó da terra — incontável", distractors: ["Que seriam tão numerosos quanto as estrelas", "Que formariam doze tribos"], reference: "Gênesis 13:16" },
        ],
        14: [
            { question: "Por que Ló foi capturado?", answer: "Estava em Sodoma quando os reis a atacaram e saquearam", distractors: ["Tentou resistir sozinho ao exército inimigo", "Foi traído por seus servos"], reference: "Gênesis 14:11-12" },
            { question: "Quem foi Melquisedeque?", answer: "Rei de Salém e sacerdote do Deus Altíssimo", distractors: ["Um profeta de Canaã", "Rei de Sodoma e aliado de Abrão"], reference: "Gênesis 14:18" },
            { question: "O que Melquisedeque trouxe a Abrão?", answer: "Pão e vinho", distractors: ["Ouro e incenso", "Armas e provisões"], reference: "Gênesis 14:18" },
            { question: "Quanto do espólio Abrão deu a Melquisedeque?", answer: "O dízimo de tudo", distractors: ["A metade", "Um quinto"], reference: "Gênesis 14:20" },
            { question: "Por que Abrão recusou receber bens do rei de Sodoma?", answer: "Para que o rei não dissesse que tinha enriquecido Abrão", distractors: ["Porque Deus lhe ordenou recusar", "Porque já tinha riqueza suficiente"], reference: "Gênesis 14:22-23" },
            { question: "Quantos homens treinados Abrão levou para resgatar Ló?", answer: "318 homens", distractors: ["500 homens", "100 homens"], reference: "Gênesis 14:14" },
            { question: "Até onde Abrão perseguiu os reis que capturaram Ló?", answer: "Até Dã e depois até Hobá, ao norte de Damasco", distractors: ["Até o rio Eufrates", "Até as fronteiras do Egito"], reference: "Gênesis 14:14-15" },
        ],
        15: [
            { question: "Qual foi a primeira palavra de Deus a Abrão na visão de Gênesis 15?", answer: "Não temas, Abrão; eu sou o teu escudo", distractors: ["Levanta-te e caminha pela terra", "Obedece-me e serei teu Deus"], reference: "Gênesis 15:1" },
            { question: "Com o que Deus comparou a descendência de Abrão?", answer: "Com as estrelas do céu", distractors: ["Com as areias do mar", "Com o pó da terra"], reference: "Gênesis 15:5" },
            { question: "O que Deus considerou a Abrão como justiça?", answer: "Sua fé no Senhor", distractors: ["Seus sacrifícios e ofertas", "Sua obediência ao deixar Ur"], reference: "Gênesis 15:6" },
            { question: "Que animais Abrão usou no ritual da aliança?", answer: "Uma novilha, uma cabra, um carneiro, uma rola e um pombinho", distractors: ["Um boi, um cordeiro e uma pomba", "Doze carneiros e doze pombas"], reference: "Gênesis 15:9" },
            { question: "O que passou entre os pedaços dos animais ao firmar a aliança?", answer: "Uma labareda de fogo", distractors: ["A presença de um anjo", "Um forte vento do norte"], reference: "Gênesis 15:17" },
            { question: "Por quantos anos Deus disse que a descendência de Abrão seria escrava numa terra estranha?", answer: "Quatrocentos anos", distractors: ["Quarenta anos", "Duzentos anos"], reference: "Gênesis 15:13" },
            { question: "Qual terra Deus prometeu à descendência de Abrão na aliança?", answer: "Desde o rio do Egito até o grande rio Eufrates", distractors: ["Apenas a terra de Canaã", "O Egito e a terra de Canaã"], reference: "Gênesis 15:18" },
        ],
        16: [
            { question: "Como se chamava a serva egípcia de Sarai?", answer: "Agar", distractors: ["Zilpa", "Bila"], reference: "Gênesis 16:1" },
            { question: "Por que Sarai deu Agar a Abrão?", answer: "Porque era estéril e queria filhos por meio da serva", distractors: ["Porque Deus assim ordenou", "Para pagar uma dívida a Abrão"], reference: "Gênesis 16:2" },
            { question: "O que Agar fez quando ficou grávida?", answer: "Desprezou Sarai, sua senhora", distractors: ["Fugiu para o Egito imediatamente", "Pediu liberdade a Abrão"], reference: "Gênesis 16:4" },
            { question: "Onde o anjo do Senhor encontrou Agar quando ela fugiu?", answer: "Junto a uma fonte de água no deserto, perto de Sur", distractors: ["Às margens do rio Nilo", "No vale de Hebrom"], reference: "Gênesis 16:7" },
            { question: "Que nome Agar deu à fonte onde encontrou o anjo?", answer: "Beer-laai-roí", distractors: ["Betel", "Massá"], reference: "Gênesis 16:14" },
            { question: "Que nome Deus mandou Agar dar ao filho?", answer: "Ismael", distractors: ["Isaque", "Eliézer"], reference: "Gênesis 16:11" },
            { question: "Quantos anos tinha Abrão quando Ismael nasceu?", answer: "86 anos", distractors: ["99 anos", "75 anos"], reference: "Gênesis 16:16" },
            { question: "O que o anjo disse sobre o caráter de Ismael?", answer: "Seria um homem selvagem, sua mão contra todos e a mão de todos contra ele", distractors: ["Seria um grande rei sobre muitas nações", "Seria um sábio e pacífico líder"], reference: "Gênesis 16:12" },
        ],
        17: [
            { question: "Por que Deus mudou o nome 'Abrão' para 'Abraão'?", answer: "Porque o tornaria pai de muitas nações", distractors: ["Porque ele foi fiel na aliança da circuncisão", "Para marcar sua saída de Ur"], reference: "Gênesis 17:5" },
            { question: "Qual sinal Deus estabeleceu para a aliança com Abraão?", answer: "A circuncisão", distractors: ["O sacrifício anual de um carneiro", "Um altar de pedras não talhadas"], reference: "Gênesis 17:10-11" },
            { question: "Por que Deus mudou o nome 'Sarai' para 'Sara'?", answer: "Porque a abençoaria e ela seria mãe de nações", distractors: ["Porque ela obedeceu à ordem da circuncisão", "Para marcar os 90 anos de idade dela"], reference: "Gênesis 17:15-16" },
            { question: "Quantos anos tinha Abraão quando recebeu a aliança da circuncisão?", answer: "99 anos", distractors: ["75 anos", "86 anos"], reference: "Gênesis 17:1" },
            { question: "O que Abraão fez ao ouvir que Sara teria um filho?", answer: "Prostrou-se e riu, dizendo em seu coração que isso era impossível", distractors: ["Chorou de alegria", "Saiu imediatamente para anunciar a notícia"], reference: "Gênesis 17:17" },
            { question: "Qual aliança Deus prometeu estabelecer with Isaque?", answer: "A aliança eterna, como com Abraão", distractors: ["Uma aliança menor que a de Abraão", "Uma aliança apenas com os descendentes de Isaque"], reference: "Gênesis 17:19" },
            { question: "Com quantos anos os homens da casa de Abraão foram circuncidados?", answer: "Abraão tinha 99 e Ismael 13 anos no mesmo dia", distractors: ["Todos tinham a mesma idade", "Isaque e Ismael foram circuncidados juntos"], reference: "Gênesis 17:24-25" },
        ],
        18: [
            { question: "Quantos visitantes apareceram a Abraão junto aos carvalhos de Manre?", answer: "Três homens", distractors: ["Dois anjos e o Senhor", "Doze anjos"], reference: "Gênesis 18:1-2" },
            { question: "O que Sara fez quando ouviu que teria um filho?", answer: "Riu dentro de si", distractors: ["Chorou de alegria", "Saiu correndo para contar a Abraão"], reference: "Gênesis 18:12" },
            { question: "Por que o Senhor disse que visitaria Sodoma?", answer: "Para ver se o clamor contra ela era verdadeiro", distractors: ["Para destruí-la imediatamente", "Para oferecer perdão aos seus habitantes"], reference: "Gênesis 18:20-21" },
            { question: "A partir de quantos justos Abraão fez Deus prometer não destruir Sodoma?", answer: "Dez justos", distractors: ["Cinquenta justos", "Um único justo"], reference: "Gênesis 18:32" },
            { question: "Qual era o clamor que chegou até Deus sobre Sodoma e Gomorra?", answer: "Era grande e o seu pecado, muito grave", distractors: ["Eles adoravam ídolos de ouro", "Oprimiam os estrangeiros"], reference: "Gênesis 18:20" },
            { question: "O que Sara preparou para os visitantes?", answer: "Abraão matou um novilho e Sara fez pães", distractors: ["Apenas água e frutos secos", "Um banquete de sete pratos"], reference: "Gênesis 18:6-8" },
            { question: "O que o visitante prometeu sobre Sara?", answer: "Que na mesma época do ano seguinte ela teria um filho", distractors: ["Que ainda naquele ano teria o filho", "Que teria um filho assim que voltasse a ser jovem"], reference: "Gênesis 18:10" },
        ],
        19: [
            { question: "O que os anjos ordenaram a Ló que fizesse?", answer: "Sair da cidade com sua família antes da destruição", distractors: ["Permanecer em casa de portas fechadas", "Advertir os habitantes de Sodoma"], reference: "Gênesis 19:12-13" },
            { question: "O que aconteceu com a mulher de Ló?", answer: "Olhou para trás e transformou-se em estátua de sal", distractors: ["Morreu nas chamas ao sair tarde", "Foi levada pelos anjos de volta à cidade"], reference: "Gênesis 19:26" },
            { question: "Para qual cidade Ló pediu para fugir em vez do monte?", answer: "Zoar", distractors: ["Gomorra", "Belém"], reference: "Gênesis 19:20-22" },
            { question: "Como Deus destruiu Sodoma e Gomorra?", answer: "Com enxofre e fogo do céu", distractors: ["Com uma grande inundação", "Com um terremoto e fogo"], reference: "Gênesis 19:24-25" },
            { question: "De onde Abraão viu a fumaça subindo como fumaça de uma fornalha?", answer: "Do lugar onde havia estado diante do Senhor", distractors: ["Do alto do monte Sinai", "Da cidade de Hebrom"], reference: "Gênesis 19:27-28" },
            { question: "Por que Deus se lembrou de Abraão ao livrar Ló?", answer: "Tirou Ló do meio da destruição, lembrando-se de Abraão", distractors: ["Porque Ló era o mais justo da cidade", "Porque Ló havia feito sacrifícios a Deus"], reference: "Gênesis 19:29" },
            { question: "O que os filhos que nasceram do relacionamento de Ló com suas filhas se tornaram?", answer: "Os antepassados de Moabe e Amom", distractors: ["Os antepassados dos filisteus", "Os antepassados dos edomitas"], reference: "Gênesis 19:37-38" },
        ],
        20: [
            { question: "Para onde Abraão foi após a destruição de Sodoma?", answer: "Para a região entre Cades e Sur, morou em Gerar", distractors: ["Voltou para Harã", "Desceu para o Egito"], reference: "Gênesis 20:1" },
            { question: "Quem era Abimeleque?", answer: "Rei de Gerar", distractors: ["Rei dos filisteus na época de Davi", "Sacerdote cananeu"], reference: "Gênesis 20:2" },
            { question: "O que Deus disse a Abimeleque em sonho sobre Sara?", answer: "Que ela era mulher casada e que ele seria morto se a retivesse", distractors: ["Que ela era irmã de Abraão", "Que Abraão seria punido por sua mentira"], reference: "Gênesis 20:3" },
            { question: "Como Abimeleque se defendeu diante de Deus?", answer: "Disse que agiu com coração íntegro e mãos limpas", distractors: ["Disse que era rei e tinha direito", "Prometeu um grande sacrifício"], reference: "Gênesis 20:4-5" },
            { question: "O que Abraão disse sobre Sara para Abimeleque?", answer: "Que ela era sua irmã — o que era parcialmente verdade", distractors: ["Que ela era viúva de um amigo", "Que ela era serva de Deus"], reference: "Gênesis 20:2,12" },
            { question: "O que Abraão recebeu de Abimeleque?", answer: "Ovelhas, bois, servos e mil moedas de prata", distractors: ["Terras e um poço de água", "Ouro e pedras preciosas"], reference: "Gênesis 20:14,16" },
            { question: "Qual bênção Abraão trouxe sobre a casa de Abimeleque?", answer: "Orou a Deus e as mulheres voltaram a ter filhos", distractors: ["Abençoou os campos com chuva", "Livrou-os de uma praga de gafanhotos"], reference: "Gênesis 20:17-18" },
        ],
        21: [
